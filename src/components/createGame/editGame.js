    ...
    async componentDidMount() {
        try {
            ...
            await this.setState({
                ...
                longitude: gameData.Geo_Location[1],
                ...
                <div className='form-area was-validated'>
                    <form onSubmit={this.handleSubmit} action='/gs'>
                        ...
                        <div className='form-group'>
                            ...
                            <input id='game-title' type='text' className='form-control' required value={this.state.gameTitle}></input>
                            {/* GAME THUMBNAIL */}
                            <label for='game-thumbnail'>Game Thumbnail</label>
                            <input id='game-thumbnail' type='text' className='form-control' required value={this.state.gameThumbnail}></input>
                            {/* GAME LOCATION */}
                            <label for='game-location'>Location</label>
                            <input id='game-location' type='text' className='form-control' required value={this.state.gameLocation}></input>
                            {/* GAME GEO LOCATION */}
                            <label for='game-longtitude'>Longtitude</label>
                            <input id='game-longtitude' type='text' className='form-control' required value={this.state.longtitude}></input>
                            <label for='game-latitude'>Latitude</label>
                            <input id='game-latitude' type='text' className='form-control' required value={this.state.latitude}></input>
                            {/* GAME DIFFICULTY*/}
                            <label for='game-difficulty'>Difficulty (1-5)</label>
                            <select id='game-difficulty' className='form-control' required value={this.state.gameDifficulty}>
                            ...
                            <select id='game-capacity' className='form-control' required value={this.state.gameCapacity}>
                            ...
                            <input id='game-story' type='text' className='form-control' required value={this.state.gameStory}></input>
                            {/* GAME TIME_LIMIT */}
                            <label for='game-time-limit'>Time Limit (minutes)</label>
                            <input id='game-time-limit' type='number' className='form-control' max='60' required value={this.state.gameTimeLimit}></input>
                            ...
                            <input id='game-total-questions' type='number' className='form-control' max='20' required value={this.state.gameTotalQuestions}></input>
                            {/* GAME TOTAL HINTS */}
                            <label for='game-total-hints'>Number of Hints Allowed (Max 20)</label>
                            <input id='game-total-hints' type='number' className='form-control' max='20' required value={this.state.gameTotalHints}></input>
                            {/* GAME HINT COUNT = 0 */}
                            {/* GAME AT QUESTION = 0 */}
                            {/* GAME QUESTION .................... */}
                            {/* GAME REVIEW = [] */}
